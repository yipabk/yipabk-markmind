...
export const Navbar = () => {
  ...
  const availableMenus: NavMenuItem[] = [
    ...
    },
    {
      ...
      linkTo: "/publikasi",
      isActive:
        pathname.includes("/publikasi") || pathname.includes("/artikel"),
      children: [
      ...
      {({ open }) => (
        <>
          <div
            ...
            className="mx-auto pl-6 pr-6 md:pr-20 font-montserrat"
          >
            <div
              style={{ transformStyle: "preserve-3d" }}
