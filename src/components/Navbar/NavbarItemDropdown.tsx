...
export const NavbarItemDropdown = ({ item }: Props) => {
  ...
  return (
    <Popover
      ...
      className="relative z-30 flex w-full md:w-auto"
    >
      {() => (
        <>
          <Popover.Button
          ...
          >
            <Popover.Panel
              ...
              className="absolute z-10 top-14 ml-[-0.5rem] transform max-w-[100px] sm:px-0"
            >
                ...
                <div className="relative grid bg-white">
                  {item.children.map((child) => (
                    <a
                      ...
                      className={`${
                        item.name === "PROGRAM" && "p-3 py-4 pr-10"
                      } ${
                    ...
                    >
                      <p
                        className={`text-xs font-[500] ${
                          item.name === "PROGRAM" && "tracking-[2.16px]"
                        } text-black`}
                      >
                        {child.name}
                      </p>
