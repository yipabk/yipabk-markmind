	...
	return (
		<div>
			<FadingHeader
				...
				<div className='text-white font-display text-3xl mb-8 tracking-wide'>"Giving is the GREATES Act of GRACE"</div>
			...
			<div className='flex flex-col justify-center items-center h-[80vh] w-full bg-blue/40'>
				<div className='flex justify-center items-center mb-16'>
					<div className='font-bold tracking-wide text-xl w-80'>Scan QR code atau transfer untuk berdonasi!</div>
					<div className='flex bg-white w-[32rem] h-48 rounded-lg drop-shadow-md py-2 px-2'>
						...
						<div className='p-2'>
							...
							<div className='font-bold text-xl mb-2'>No. Rek : 766 - 03 - 18181</div>
							<div>Yayasan Indonesia Peduli Anak Berkebutuhan Khusus (YIPABK)</div>
						</div>
					</div>
				</div>
