...
export const AboutUs = () => {
	return (
		<div className='flex md:flex-row flex-col-reverse md:px-8 xl:px-24 2xl:px-48 py-24 md:py-48 items-center w-100 bg-orange gap-16 md:gap-4'>
			<div data-aos='fade-right' data-aos-once='true' className='text-white md:mr-10 font-montserrat'>
				...
				<div className='text-sm lg:text-[14px] font-[400] w-[16rem] sm:w-[24rem] lg:w-[34rem] leading-5 text-justify'>
					...
					<p className='leading-[21px]'>Dr. Alice Arianto, Psy.D., CGP. - Pendiri YIPABK</p>
				</div>
			</div>
