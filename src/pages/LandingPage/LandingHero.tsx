...
export const LandingHero = () => {
	return (
		<div className='flex items-center p-12 md:p-24 lg:p-36 xl:p-48 relative w-100 h-[100vh] overflow-hidden'>
			<div>
				<div className='text-3xl sm:text-4xl tracking-wide max-w-[28rem] mb-4 font-display text-white'>
					Yayasan Indonesia Peduli Anak Berbutuhan Khusus
				</div>
				<div className='text-base sm:text-base max-w-[26rem] tracking-wide mb-16 font-light text-white'>
				...
				<div className='flex flex-col sm:flex-row gap-4 w-56 sm:w-auto'>
