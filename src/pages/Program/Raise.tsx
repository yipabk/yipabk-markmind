    ...
    return (
        <div>
            <FadingHeader variant='black'
                ...
                <div className='text-white font-display text-5xl mb-16'>RAISE</div>
                <div className='text-center text-grey font-display text-5xl mb-16'>(Resource, Awareness, Inspiration, Stories, Education)</div>
            </FadingHeader>
                ...
                <div className='flex flex-col bg-white w-full justify-center items-center min-h-[100vh]'>
                    ...
                    <div className='flex md:flex-row flex-col md:px-8 xl:px-24 2xl:px-48 py-24 md:py-48 items-center w-100 gap-16 md:gap-4'>
                        <div className='text-black mr-10'>
                            <div className='text-3xl lg:text-5xl tracking-wide mb-6 font-display'>1. Program "Pustaka Kita"</div>
                    ...
                    <div className='flex md:flex-col flex-col md:px-8 xl:px-24 2xl:px-48 py-24 md:py-48 items-center w-full gap-16 md:gap-4'>
                        <div className='text-black mx-4 md:mx-0'>
                            <div className='text-3xl lg:text-5xl tracking-wide mb-6 font-display'>2. Kampanye Peduli ABK</div>
                            <div className='text-sm lg:text-base font-light leading-5 text-justify'>
                                <div className='mb-4'>
                                    Program “Kita Bisa” merupakan program layanan pendampingan bagi orang tua dengan anak berkebutuhan khusus.
                                </div>
                                <div className='mb-4'>
                                   1. Program “Kita Bisa” merupakan program layanan pendampingan bagi orang tua dengan anak berkebutuhan khusus.
                                </div>
                                <div className='mb-4'>
                                    2. Kami meyakini bahwa setiap orang tua memiliki peran yang sangat besar dan kuat dalam membantu anak mengatasi berbagai hambatan dan kesulitan yang diakibatkan kondisi kekhususan mereka.
                                </div>
                                <div className='mb-4'>
                                    3. Oleh sebab itu, orang tua perlu belajar memahami kondisi anak dan mengerti metode intervensi yang tepat untuk pengaplikasian di rumah agar anak dapat bertumbuh, berkembang, belajar, dan melakukan aktivitas yang bermakna.
                                </div>
                            </div>
                        </div>
                        <div className='flex w-full justify-center'>
