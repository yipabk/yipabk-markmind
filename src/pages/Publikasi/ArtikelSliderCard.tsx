...
export const ArtikelSliderCard = ({
  image,
  title,
  content,
  linkTo,
}: ArtikelSliderCardProps) => {
  return (
    <div className="w-full flex items-center justify-center">
      <div className="flex flex-col border border-orange h-full justify-between max-w-[337px]">
        ...
        <a
          href={linkTo}
          className="flex justify-center fill-white bg-orange py-4 hover:bg-white hover:fill-orange border border-transparent hover:border-orange duration-200 cursor-pointer"
        >
          <ArrowDown />
        </a>
      </div>
