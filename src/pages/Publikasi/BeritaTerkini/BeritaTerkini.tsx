      ...
      <div className="flex flex-col justify-center items-center w-100 min-h-[100vh] px-4 md:px-16 w-full bg-blue/40 gap-12">
        <div className="flex flex-col bg-white w-full py-16 min-h-[100vh] gap-24">
          <div className="flex flex-col gap-20">
            ...
            >
              {`Program Aku Bisa Belajar dan Program Guru Bisa Belajar
							bersama MDRT Foundation`}
            </div>
            <div
              data-aos="fade-up"
              data-aos-once="true"
              className="flex flex-wrap items-center gap-24 justify-center"
            >
              <img src={bentara} alt="" />
              <img src={mdrt} alt="" />
              <img src={peace} alt="" />
          ...
          <div className="flex flex-col gap-40">
            <div className="flex flex-col lg:flex-row px-8 md:px-20 lg:px-40 justify-between items-center gap-8">
              <div
                data-aos="fade-left"
                data-aos-once="true"
                className="flex flex-col gap-8 sm:w-2/5"
              >
                <img src={image2} alt="" />
                <img src={image1} alt="" />
              </div>
            ...
            <div className="flex flex-col-reverse lg:flex-row px-8 md:px-20 lg:px-40 justify-between items-center gap-6">
              ...
              <div
                data-aos="fade-right"
                data-aos-once="true"
                className="sm:w-2/5 flex flex-col gap-6"
              >
                <img src={berita} alt="" />
              </div>
            </div>
            <div className="flex flex-col-reverse lg:flex-row px-8 md:px-20 lg:px-40 justify-between items-center gap-6">
              <div
                data-aos="fade-right"
                data-aos-once="true"
                className="flex flex-col sm:w-1/2 gap-6"
              >
                <img src={image3} alt="" />
              </div>
              <div
              ...
              >
                ...
                <div className="lg:whitespace-pre-line">
                  ...
                  sejumlah SD Negeri di wilayah DKI Jakarta.
                </div>
              </div>
            </div>

            <div className="flex flex-col-reverse xl:flex-row px-8 md:px-20 lg:px-40 justify-between items-center gap-6">
              <div
                data-aos="fade-left"
                data-aos-once="true"
              ...
              >
                ...
                <div>
                  ...
                  <div className="whitespace-pre-line ml-2">
                    {`1. Memperlengkapi tenaga pendidik dengan kemampuan yang memadai agar mampu mengidentifikasi PDBK

										2. Memperlengkapi tenaga pendidik dengan kemampuan  membuat program pembelajaran individual

										3. Meningkatkan layanan pendidikan inklusif guna memberikan pendidikan yang baik dan berkualitas bagi ABK di wilayah DKI Jakarta

										4. Membangun sudut pandang positif dari para tenaga pendidik terhadap PDBK yang mau belajar`}
                  </div>
                </div>
              </div>
              <div
