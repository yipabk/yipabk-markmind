...
export const Publikasi = () => {
  ...
  useEffect(() => {
    if (
      refMapping[targetId] !== undefined &&
      refMapping[targetId].current !== null
    ) {
  ...
  return (
    <div>
      ...
      <div className="px-4 sm:px-12 lg:px-32 py-16">
        <div
          ref={beritaTerkiniRef}
          id="berita-terkini"
          className="scroll-m-20 min-h-[60vh] mb-32"
        >
          <div
            data-aos="fade-down"
            data-aos-once="true"
        ...
        <div
          id="artikel"
          ref={artikelRef}
          className="scroll-m-20 mb-32 flex flex-col"
        >
          <div
            data-aos="fade-down"
            data-aos-once="true"
          ...
          <Slider<ArtikelSliderCardProps>
            ...
            renderItem={(item) => (
              <ArtikelSliderCard key={`${item.title}-${item.id}`} {...item} />
            )}
          />
        </div>
        <div
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 sm:px-16">
            <div
              data-aos="fade-right"
              data-aos-once="true"
