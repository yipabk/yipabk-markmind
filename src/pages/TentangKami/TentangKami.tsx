...
export const TentangKami = () => {
	...
	return (
		<div>
			<FadingHeader variant='black' className='flex justify-center items-end w-full h-[42vh] mt-20' bg={hero}>
			...
			<div>
				...
				<div className='w-full h-full py-24 px-4 sm:px-6 md:px-12 lg:px-24 items-center flex flex-col xl:flex-row gap-12'>
					<div
						data-aos='fade-right'
						data-aos-once='true'
